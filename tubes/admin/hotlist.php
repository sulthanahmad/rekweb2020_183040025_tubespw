...
$hotlist= query("SELECT * FROM hotlist");
  ...
  if (isset ($_GET['urut'])) {
      $hotlist = urutHotlist($_GET['metode2']);
  }else{
      $hotlist = query("SELECT * FROM hotlist");
  }
...
<a href="../tambah_hotlist.php" class="btn btn-success" style="margin-top: 60px; margin-left: 40px;">Tambah Data</a>
<form action="" method="get">
  <button class="btn btn-success" type="submit" name="urut" id="urut" style="margin-top:-55px; margin-left: 1415px;" >Urutkan</button>
  <select class="form-control" style="width: 10%; margin-left: 1260px; margin-top: -55px;" name="metode2" id="metode2"> 
...
<div id="container">
  <table border="1" cellpadding="10" cellspacing="0" style="background-color: white; text-align: center; width: 98%; margin:auto; margin-top: 10px;">
    ...
    <?php $number=1; ?>
      ...
      <?php foreach ($hotlist as $bar) : ?>
      <tr>
          <td width=""><?= $number ?></td>
          <td width="185px"><a href="../edit_hotlist.php?id=<?= $bar["id"];?>" class="btn btn-success">Edit</a> |
...
<div class="footer">
    ...
    <script src="../js/script_hotlist.js"></script>
